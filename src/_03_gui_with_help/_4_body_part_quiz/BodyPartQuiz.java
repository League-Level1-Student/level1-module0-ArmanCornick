...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if(guess.equalsIgnoreCase("arnold schwarzenegger")||guess.equalsIgnoreCase("arnold")) {
			...
			JOptionPane.showMessageDialog(null, "Wrong, it was Arnold Schwarznegger");		
		}
		// 6. Otherwise:
		...
		if(guess3.equalsIgnoreCase("Leonardo Dicaprio")||guess3.equalsIgnoreCase("Leonardo")) {
			JOptionPane.showMessageDialog(null, "Correct!");	
			score += 1;
		} else {
			JOptionPane.showMessageDialog(null, "Wrong, it was Leonardo Dicaprio");		
		}
		showNextImage();
		String guess112 = JOptionPane.showInputDialog("who is this?");
		if(guess112.equalsIgnoreCase("Morgan Freeman")||guess112.equalsIgnoreCase("morgan")) {
			JOptionPane.showMessageDialog(null, "Correct!");	
			score += 1;
		} else {
		...
		showNextImage();
		String guess12 = JOptionPane.showInputDialog("who is this?");
		if(guess12.equalsIgnoreCase("Jack black")||guess12.equalsIgnoreCase("jack")) {
			JOptionPane.showMessageDialog(null, "Correct!");	
			score += 1;
		} else {
