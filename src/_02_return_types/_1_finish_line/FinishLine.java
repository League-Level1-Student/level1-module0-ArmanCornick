...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		boolean check = hasCrossedFinishLine();
		//5. If the robot has crossed the finish line... 
		if(check==true){
			JOptionPane.showMessageDialog(null, "Your robot finished, it traveled " + distance + "." );			
		} else {
			JOptionPane.showMessageDialog(null, "Your robot did not finish, it traveled " + distance + "." );	
		}
