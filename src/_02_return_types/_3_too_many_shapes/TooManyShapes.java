...
public class TooManyShapes {
	...
	public static void main(String[] args) {
		...
		String sides1 = JOptionPane.showInputDialog("How many sides do you want on your shape?");
		int sides = Integer.parseInt(sides1);
		//2. Ask the user how many shapes they want
		String shapes1 = JOptionPane.showInputDialog("How many shapes do you want?");
		int shapes = Integer.parseInt(shapes1);
